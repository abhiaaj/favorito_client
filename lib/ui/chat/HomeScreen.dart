...
class HomeScreen extends StatelessWidget {
    ...
    return Center(
      child: ListView(shrinkWrap: true, children: [
        ...
        Text("Search user",
            ...
            style: Theme.of(RIKeys.josKeys31.currentContext)
                .textTheme
                .headline6
                .copyWith(
  ...
  newHistory(String title) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(fontSize: 14.0, color: myGrey)),
    );
  }
}
