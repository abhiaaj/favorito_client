...
class LoginProvider extends BaseProvider {
  ...
  List<String> prefix = ['user', 'password'];
  ...
  void getDeviceToken() {
    _fbToken.getToken().then((value) {
      print("this is new Token1:$value");
      _token = value;
    });
  }
}
