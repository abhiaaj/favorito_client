        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ClusterMap(list: searchResult.data)));
          },
          child: Padding(
        ...
        onTap: () {
          ...
          if (result.isPro == '1')
            context
                ...
                .funPromoClicks(result.proKey ?? '', result.isPro);
                        ...
                        children: [
                            ...
                            child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                        result.businessName.capitalize(),
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: sm.w(2), top: sm.h(1)),
                                    child: Text(
                                        "${((double.parse(result?.distance?.toString() ?? '0.0')))?.toStringAsFixed(1)} km | ${result?.townCity ?? ''}",
                                        style: Theme.of(context)
                                            .textTheme
                                            .headline6
                                            .copyWith(
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: sm.w(2), top: sm.h(1)),
                                    child: Text(
                                        result?.businessStatus.capitalize() ??
                                            '',
                                        style: Theme.of(context)
                                            .textTheme
                                            .headline6
                                  ...
                                  (result.startHours != null &&
                                          result.endHours != null)
                                      ? Padding(
                                          padding: EdgeInsets.only(
                                              left: sm.w(2), top: sm.h(1)),
                                          child: Text(
                                              "Opens | ${result.startHours.substring(0, 5)} Closes | ${result.endHours.substring(0, 5)}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .headline6
                                                  .copyWith(
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              // margin:
                              //     EdgeInsets.only(top: sm.h(5), right: sm.h(0)),
                              child: IconButton(
